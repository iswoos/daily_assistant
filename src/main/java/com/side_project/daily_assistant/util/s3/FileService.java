...
import static com.side_project.daily_assistant.util.ValueCheck.*;
...
public class FileService {
	...
	private String getPutPreSignedUrl(String fullFilePath) {
		GeneratePresignedUrlRequest generatePresignedUrlRequest = getGeneratePutPreSignedUrlRequest(bucket,
			fullFilePath);
